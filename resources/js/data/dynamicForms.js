export const dynamicForms = {
    ...
    'admissions-application': {
        titleEn: 'Admissions Application',
        titleAr: 'طلب القبول',
        submitLabelEn: 'Submit for Admissions Review',
        submitLabelAr: 'إرسال الطلب للمراجعة',
        fields: [
            { name: 'fullName', type: 'text', labelEn: 'Full Name', labelAr: 'الاسم الكامل', required: true },
            { name: 'email', type: 'email', labelEn: 'Email Address', labelAr: 'البريد الإلكتروني', required: true },
            { name: 'phone', type: 'tel', labelEn: 'Phone Number', labelAr: 'رقم الهاتف', required: true },
            { name: 'applicantType', type: 'select', labelEn: 'Applicant Type', labelAr: 'فئة المتقدم', required: true, options: [
                { value: '', labelEn: 'Select applicant type', labelAr: 'اختر فئة المتقدم' },
                { value: 'new', labelEn: 'New Entrant', labelAr: 'طالب مستجد' },
                { value: 'transfer', labelEn: 'Transfer Student', labelAr: 'طالب تحويل' },
                { value: 'equivalency', labelEn: 'Certificate Equivalency', labelAr: 'طالب معادلة' },
                { value: 'international', labelEn: 'International Applicant', labelAr: 'طالب دولي' },
            ] },
            { name: 'targetFaculty', type: 'select', labelEn: 'Preferred Faculty', labelAr: 'الكلية المرغوبة', required: true, options: [
                { value: '', labelEn: 'Select faculty', labelAr: 'اختر الكلية' },
                { value: 'medicine', labelEn: 'Faculty of Medicine', labelAr: 'كلية الطب البشري' },
                { value: 'dentistry', labelEn: 'Faculty of Dentistry', labelAr: 'كلية طب الأسنان' },
                { value: 'pharmacy', labelEn: 'Faculty of Pharmacy', labelAr: 'كلية الصيدلة' },
                { value: 'artificial-intelligence', labelEn: 'Faculty of Artificial Intelligence', labelAr: 'كلية الذكاء الاصطناعي' },
                { value: 'building-construction-engineering', labelEn: 'Faculty of Building Construction Engineering', labelAr: 'كلية هندسة التشييد والبناء' },
                { value: 'petroleum', labelEn: 'Faculty of Petroleum Engineering', labelAr: 'كلية هندسة البترول' },
                { value: 'business-administration', labelEn: 'Faculty of Business Administration', labelAr: 'كلية إدارة الأعمال' },
            ] },
            { name: 'secondaryCertificate', type: 'text', labelEn: 'Secondary Certificate Type', labelAr: 'نوع الشهادة الثانوية', required: true },
            { name: 'certificateCountry', type: 'text', labelEn: 'Certificate Issuing Country', labelAr: 'بلد إصدار الشهادة', required: true },
            { name: 'notes', type: 'textarea', labelEn: 'Additional Information', labelAr: 'معلومات إضافية', placeholderEn: 'Do not include bank details, passwords, or identity document numbers.', placeholderAr: 'لا تدرج بيانات مصرفية أو كلمات مرور أو أرقام وثائق الهوية.', required: false },
            { name: 'agreeToTerms', type: 'checkbox', labelEn: 'I confirm that the information is accurate and understand that submission does not reserve a seat or guarantee admission.', labelAr: 'أؤكد صحة المعلومات وأفهم أن إرسال الطلب لا يحجز مقعداً ولا يضمن القبول.', required: true },
        ],
    },
    'job-application': {
