    ...
    <div class="container relative z-10 pb-14 text-white">
        ...
        @if (is_array($course))
            <div class="mx-auto max-w-4xl">
                ...
                <p class="mx-auto mt-4 max-w-[760px] text-sm font-semibold leading-7 text-white/82">{{ $course['description'] ?? '' }}</p>
            </div>
        @else
