...
@section('content')
    ...
    <section class="bg-white py-12 font-hacen md:py-16" @if($event) x-data="dynamicFormShell()" data-form-id="{{ $formId }}" data-locale="{{ $locale }}" data-event-source="research-conferences" data-event-id="{{ $event['id'] }}" data-preview="{{ !empty($isPreview) ? '1' : '0' }}" @endif>
