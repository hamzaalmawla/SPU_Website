...
final class ContactMessageStatusUpdated extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(subject: Lang::get('mail.contact.status.subject', ['reference' => $this->referenceNumber], $this->contentLocale));
    }

    public function content(): Content
    {
        return new Content(view: 'mail.form-submission.contact-status-updated', with: [
