...
use App\Filament\Resources\FacultyStudentProjectResource\Pages;
...
class FacultyStudentProjectResource extends Resource
{
    protected static ?string $model = FacultyStudentProject::class;
    ...
    {
        return __('admin.navigation.items.faculty_student_projects');
    }
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Repeater::make('translations')->relationship()->schema([
                ...
                TextInput::make('supervisor')->maxLength(255),
    ...
    {
        return ['index' => Pages\ListFacultyStudentProjects::route('/'), 'create' => Pages\CreateFacultyStudentProject::route('/create'), 'edit' => Pages\EditFacultyStudentProject::route('/{record}/edit')];
    }
}
