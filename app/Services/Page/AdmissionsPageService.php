...
final class AdmissionsPageService implements AdmissionsPageServiceInterface
{
    ...
    private function howToApplyPayload(): array
    {
        return [
            ...
            'steps' => [
                ['number' => '01', 'titleEn' => 'Choose Faculty', 'titleAr' => 'اختر الكلية', 'descEn' => 'Explore our diverse range of faculties and programs to find the perfect fit for your career aspirations.', 'descAr' => 'استكشف كلياتنا وبرامجنا المتنوعة لتجد الخيار الأنسب لطموحاتك المهنية.', 'ctaEn' => 'Explore Programs', 'ctaAr' => 'استكشف البرامج', 'href' => '/faculties/'],
