...
final class LegacyImportAuditCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $moduleTargetTables = [
            ...
            'news' => ['news_categories', 'news_category_translations', 'news_articles', 'news_article_translations', 'news_article_seo_meta', 'news_article_attachments'],
